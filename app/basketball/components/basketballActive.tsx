...
/* ============================================================
   ACTIVE GAME PAGE
   ⛔️ NO use(params) — receives props directly
============================================================ */
export default function ActiveBasketballPage({
  ...
  // ✅ MUST return a synchronous cleanup function
  return () => {
    try {
      supabase.removeChannel(channel);  // NOT returned, just called
    } catch (err) {
              ...
              >
                ...
                <div
                  style={{
                    ...
                    boxShadow: "0 0 6px rgba(214,40,40,0.6)",
                  }}
                />
